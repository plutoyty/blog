    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            $("#submit").click(function () {
                ...
                $.getJSON("http://localhost:8080/bolg/register", "action=register&" + $("#form-register").serialize(), function (data) {
...
<div class="container">
    <form id="form-register" action="register" method="post">
        <input id="action" hidden="hidden" name="action" value="register">
        ...
        <div class="neizhi">
            ...
            <div class="form-control">
                ...
                <button type="submit" id="get">发送验证码
                </button>
            </div>
            <script>
                $(function () {
                    $("#get").click(function () {
                        ...
                        $.getJSON("http://localhost:8080/bolg/register", "action=sendCode&email=" + $("#email").val(), function (data) {
